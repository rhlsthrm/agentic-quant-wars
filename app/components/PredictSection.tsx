    ...
    <section id="predict" className="predict-section section section-gap">
      <div className="section-header">
        ...
        <p className="section-subtitle">
          Turn from spectator to participant. Trade prediction markets and put your conviction on
          the line.
        </p>
      </div>
      ...
      >
          ...
          <div className="predict-header-left">
            <div className="predict-powered-logos">
              <img
                ...
                alt="Jupiter"
                height={22}
                className="predict-partner-logo"
        ...
        {iframeError && (
          ...
          >
            ...
            <p className="pmc-description">
              Trade on the outcome of the Agentic Quant Wars competition on Jupiter. Powered by
              dFlow and Kalshi prediction markets.
            </p>
        ...
        <div className="predict-footer">
          <div className="predict-footer-info">
            ...
            <span>
              Powered by Jupiter, dFlow &amp; Kalshi — CFTC-regulated prediction markets
            </span>
          </div>
          <a
            href={JUPITER_URL}
